...
* For [the browser](https://github.com/dhowe/rita2js/releases/download/v2.0.0-beta.27/rita-web.js) (1.3mb)
* For [the browser (no lexicon)](https://github.com/dhowe/rita2js/releases/download/v2.0.0-beta.27/rita-web-nolex.js) (.5mb)
