...
* For [the browser](https://github.com/dhowe/rita2js/releases/download/v2.0.0-beta.13/rita-web.js) (1.4mb)
* For [the browser (no lexicon)](https://github.com/dhowe/rita2js/releases/download/v2.0.0-beta.13/rita-web-nolex.js) (.5mb)
