...
describe('RiTa.Lexicon', function () {
  ...
  it("Should call isStem", () => {
    ...
    expect(RiTa.lexicon().isStem("across")).to.be.true;
    expect(RiTa.lexicon().isStem("activ")).to.be.true;
    expect(RiTa.lexicon().isStem("adulter")).to.be.true;
    expect(RiTa.lexicon().isStem("allianc")).to.be.true;
    expect(RiTa.lexicon().isStem("beautifi")).to.be.true;
    expect(RiTa.lexicon().isStem("bestsel")).to.be.true;
    expect(RiTa.lexicon().isStem("blond")).to.be.true;
    expect(RiTa.lexicon().isStem("borderlin")).to.be.true;
    expect(RiTa.lexicon().isStem("brave")).to.be.true;
    expect(RiTa.lexicon().isStem("calor")).to.be.true;
    expect(RiTa.lexicon().isStem("central")).to.be.true;
    expect(RiTa.lexicon().isStem("certifi")).to.be.true;
    expect(RiTa.lexicon().isStem("choppi")).to.be.true;
    expect(RiTa.lexicon().isStem("cigarett")).to.be.true;
    expect(RiTa.lexicon().isStem("cogniz")).to.be.true;
    expect(RiTa.lexicon().isStem("delicatessen")).to.be.true;
    expect(RiTa.lexicon().isStem("disaffect")).to.be.true;
    expect(RiTa.lexicon().isStem("dog")).to.be.true;
    expect(RiTa.lexicon().isStem("drachma")).to.be.true;
    expect(RiTa.lexicon().isStem("dualism")).to.be.true;
    expect(RiTa.lexicon().isStem("dwell")).to.be.true;
    expect(RiTa.lexicon().isStem("earthenwar")).to.be.true;
    expect(RiTa.lexicon().isStem("efficaci")).to.be.true;
    expect(RiTa.lexicon().isStem("elus")).to.be.true;
    expect(RiTa.lexicon().isStem("emiss")).to.be.true;
    expect(RiTa.lexicon().isStem("environment")).to.be.true;
    expect(RiTa.lexicon().isStem("fisherman")).to.be.true;
    expect(RiTa.lexicon().isStem("fragil")).to.be.true;
    expect(RiTa.lexicon().isStem("fundamentalist")).to.be.true;
    expect(RiTa.lexicon().isStem("futil")).to.be.true;
    expect(RiTa.lexicon().isStem("fuzz")).to.be.true;
    expect(RiTa.lexicon().isStem("garag")).to.be.true;
    expect(RiTa.lexicon().isStem("gass")).to.be.true;
    expect(RiTa.lexicon().isStem("govern")).to.be.true;
    expect(RiTa.lexicon().isStem("groov")).to.be.true;
    expect(RiTa.lexicon().isStem("guttur")).to.be.true;
    expect(RiTa.lexicon().isStem("hamburg")).to.be.true;
    expect(RiTa.lexicon().isStem("haphazard")).to.be.true;
    expect(RiTa.lexicon().isStem("haunt")).to.be.true;
    expect(RiTa.lexicon().isStem("headlong")).to.be.true;
    expect(RiTa.lexicon().isStem("hubbub")).to.be.true;
    expect(RiTa.lexicon().isStem("hungrili")).to.be.true;
    expect(RiTa.lexicon().isStem("hypoglycem")).to.be.true;
    // correct stem but original word not in dict
    expect(RiTa.lexicon().isStem("abut")).not.to.be.true;
    expect(RiTa.lexicon().isStem("airdrop")).not.to.be.true;
    expect(RiTa.lexicon().isStem("waylay")).not.to.be.true;
    expect(RiTa.lexicon().isStem("backslid")).not.to.be.true;
    expect(RiTa.lexicon().isStem("bejewel")).not.to.be.true;
    expect(RiTa.lexicon().isStem("blab")).not.to.be.true;
    expect(RiTa.lexicon().isStem("brutifi")).not.to.be.true;
    expect(RiTa.lexicon().isStem("bullwhip")).not.to.be.true;
    expect(RiTa.lexicon().isStem("catnap")).not.to.be.true;
    expect(RiTa.lexicon().isStem("clop")).not.to.be.true;
    expect(RiTa.lexicon().isStem("verbifi")).not.to.be.true;
    expect(RiTa.lexicon().isStem("dandifi")).not.to.be.true;
    expect(RiTa.lexicon().isStem("declassifi")).not.to.be.true;
    expect(RiTa.lexicon().isStem("disbar")).not.to.be.true;
    expect(RiTa.lexicon().isStem("disint")).not.to.be.true;
    expect(RiTa.lexicon().isStem("empanel")).not.to.be.true;
    expect(RiTa.lexicon().isStem("fib")).not.to.be.true;
    expect(RiTa.lexicon().isStem("flog")).not.to.be.true;
    expect(RiTa.lexicon().isStem("ghostwritten")).not.to.be.true;
    expect(RiTa.lexicon().isStem("glom")).not.to.be.true;
    expect(RiTa.lexicon().isStem("hypertrophi")).not.to.be.true;
    expect(RiTa.lexicon().isStem("interlaid")).not.to.be.true;
    expect(RiTa.lexicon().isStem("jut")).not.to.be.true;
    expect(RiTa.lexicon().isStem("miscarri")).not.to.be.true;
    expect(RiTa.lexicon().isStem("mortifi")).not.to.be.true;
    expect(RiTa.lexicon().isStem("overbid")).not.to.be.true;
    expect(RiTa.lexicon().isStem("overgrow")).not.to.be.true;
    expect(RiTa.lexicon().isStem("quickstep")).not.to.be.true;
    expect(RiTa.lexicon().isStem("recommit")).not.to.be.true;
    expect(RiTa.lexicon().isStem("rewound")).not.to.be.true;
    expect(RiTa.lexicon().isStem("scram")).not.to.be.true;
    expect(RiTa.lexicon().isStem("sightseen")).not.to.be.true;
    expect(RiTa.lexicon().isStem("skydov")).not.to.be.true;
    expect(RiTa.lexicon().isStem("unplug")).not.to.be.true;
    expect(RiTa.lexicon().isStem("stencil")).not.to.be.true;
    expect(RiTa.lexicon().isStem("spellbind")).not.to.be.true;
    expect(RiTa.lexicon().isStem("subjectifi")).not.to.be.true;
    expect(RiTa.lexicon().isStem("sup")).not.to.be.true;
    expect(RiTa.lexicon().isStem("syllabifi")).not.to.be.true;
    expect(RiTa.lexicon().isStem("snog")).not.to.be.true;
    expect(RiTa.lexicon().isStem("unmak")).not.to.be.true;
    expect(RiTa.lexicon().isStem("stupefi")).not.to.be.true;
    expect(RiTa.lexicon().isStem("sulli")).not.to.be.true;
    expect(RiTa.lexicon().isStem("tram")).not.to.be.true;
    expect(RiTa.lexicon().isStem("underpay")).not.to.be.true;
    expect(RiTa.lexicon().isStem("understudi")).not.to.be.true;
    expect(RiTa.lexicon().isStem("unpin")).not.to.be.true;
    expect(RiTa.lexicon().isStem("unzip")).not.to.be.true;
    expect(RiTa.lexicon().isStem("whir")).not.to.be.true;
    expect(RiTa.lexicon().isStem("yakk")).not.to.be.true;
    expect(RiTa.lexicon().isStem("yap")).not.to.be.true;
    // incorrect stems
    expect(RiTa.lexicon().isStem("body")).not.to.be.true;
    expect(RiTa.lexicon().isStem("justify")).not.to.be.true;
    expect(RiTa.lexicon().isStem("cancelled")).not.to.be.true;
    expect(RiTa.lexicon().isStem("trolling")).not.to.be.true;
