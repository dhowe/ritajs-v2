...
describe('RiTa.Lexicon', function () {
  ...
  it("Should call isStem", () => {
    ...
    // stem in dict
    expect(lex.isStem("chang")).to.be.true;
    expect(lex.isStem("accid")).to.be.true;
    expect(lex.isStem("accept")).to.be.true;
    expect(lex.isStem("bear")).to.be.true;
    expect(lex.isStem("bodi")).to.be.true;
    expect(lex.isStem("book")).to.be.true;
    expect(lex.isStem("box")).to.be.true;
    expect(lex.isStem("across")).to.be.true;
    expect(lex.isStem("activ")).to.be.true;
    expect(lex.isStem("adulter")).to.be.true;
    expect(lex.isStem("allianc")).to.be.true;
    expect(lex.isStem("beautifi")).to.be.true;
    expect(lex.isStem("bestsel")).to.be.true;
    expect(lex.isStem("blond")).to.be.true;
    expect(lex.isStem("borderlin")).to.be.true;
    expect(lex.isStem("brave")).to.be.true;
    expect(lex.isStem("calor")).to.be.true;
    expect(lex.isStem("central")).to.be.true;
    expect(lex.isStem("certifi")).to.be.true;
    expect(lex.isStem("choppi")).to.be.true;
    expect(lex.isStem("cigarett")).to.be.true;
    expect(lex.isStem("cogniz")).to.be.true;
    expect(lex.isStem("delicatessen")).to.be.true;
    expect(lex.isStem("disaffect")).to.be.true;
    expect(lex.isStem("dog")).to.be.true;
    expect(lex.isStem("drachma")).to.be.true;
    expect(lex.isStem("dualism")).to.be.true;
    expect(lex.isStem("dwell")).to.be.true;
    expect(lex.isStem("earthenwar")).to.be.true;
    expect(lex.isStem("efficaci")).to.be.true;
    expect(lex.isStem("elus")).to.be.true;
    expect(lex.isStem("emiss")).to.be.true;
    expect(lex.isStem("environment")).to.be.true;
    expect(lex.isStem("fisherman")).to.be.true;
    expect(lex.isStem("fragil")).to.be.true;
    expect(lex.isStem("fundamentalist")).to.be.true;
    expect(lex.isStem("futil")).to.be.true;
    expect(lex.isStem("fuzz")).to.be.true;
    expect(lex.isStem("garag")).to.be.true;
    expect(lex.isStem("gass")).to.be.true;
    expect(lex.isStem("govern")).to.be.true;
    expect(lex.isStem("groov")).to.be.true;
    expect(lex.isStem("guttur")).to.be.true;
    expect(lex.isStem("hamburg")).to.be.true;
    expect(lex.isStem("haphazard")).to.be.true;
    expect(lex.isStem("haunt")).to.be.true;
    expect(lex.isStem("headlong")).to.be.true;
    expect(lex.isStem("hubbub")).to.be.true;
    expect(lex.isStem("hungrili")).to.be.true;
    expect(lex.isStem("hypoglycem")).to.be.true;

    // correct stem but original word not in dict
    expect(lex.isStem("abut")).not.to.be.true;
    expect(lex.isStem("airdrop")).not.to.be.true;
    expect(lex.isStem("waylay")).not.to.be.true;
    expect(lex.isStem("backslid")).not.to.be.true;
    expect(lex.isStem("bejewel")).not.to.be.true;
    expect(lex.isStem("blab")).not.to.be.true;
    expect(lex.isStem("brutifi")).not.to.be.true;
    expect(lex.isStem("bullwhip")).not.to.be.true;
    expect(lex.isStem("catnap")).not.to.be.true;
    expect(lex.isStem("clop")).not.to.be.true;
    expect(lex.isStem("verbifi")).not.to.be.true;
    expect(lex.isStem("dandifi")).not.to.be.true;
    expect(lex.isStem("declassifi")).not.to.be.true;
    expect(lex.isStem("disbar")).not.to.be.true;
    expect(lex.isStem("disint")).not.to.be.true;
    expect(lex.isStem("empanel")).not.to.be.true;
    expect(lex.isStem("fib")).not.to.be.true;
    expect(lex.isStem("flog")).not.to.be.true;
    expect(lex.isStem("ghostwritten")).not.to.be.true;
    expect(lex.isStem("glom")).not.to.be.true;
    expect(lex.isStem("hypertrophi")).not.to.be.true;
    expect(lex.isStem("interlaid")).not.to.be.true;
    expect(lex.isStem("jut")).not.to.be.true;
    expect(lex.isStem("miscarri")).not.to.be.true;
    expect(lex.isStem("mortifi")).not.to.be.true;
    expect(lex.isStem("overbid")).not.to.be.true;
    expect(lex.isStem("overgrow")).not.to.be.true;
    expect(lex.isStem("quickstep")).not.to.be.true;
    expect(lex.isStem("recommit")).not.to.be.true;
    expect(lex.isStem("rewound")).not.to.be.true;
    expect(lex.isStem("scram")).not.to.be.true;
    expect(lex.isStem("sightseen")).not.to.be.true;
    expect(lex.isStem("skydov")).not.to.be.true;
    expect(lex.isStem("unplug")).not.to.be.true;
    expect(lex.isStem("stencil")).not.to.be.true;
    expect(lex.isStem("spellbind")).not.to.be.true;
    expect(lex.isStem("subjectifi")).not.to.be.true;
    expect(lex.isStem("sup")).not.to.be.true;
    expect(lex.isStem("syllabifi")).not.to.be.true;
    expect(lex.isStem("snog")).not.to.be.true;
    expect(lex.isStem("unmak")).not.to.be.true;
    expect(lex.isStem("stupefi")).not.to.be.true;
    expect(lex.isStem("sulli")).not.to.be.true;
    expect(lex.isStem("tram")).not.to.be.true;
    expect(lex.isStem("underpay")).not.to.be.true;
    expect(lex.isStem("understudi")).not.to.be.true;
    expect(lex.isStem("unpin")).not.to.be.true;
    expect(lex.isStem("unzip")).not.to.be.true;
    expect(lex.isStem("whir")).not.to.be.true;
    expect(lex.isStem("yakk")).not.to.be.true;
    expect(lex.isStem("yap")).not.to.be.true;

    // incorrect stems
    expect(lex.isStem("body")).not.to.be.true;
    expect(lex.isStem("justify")).not.to.be.true;
    expect(lex.isStem("cancelled")).not.to.be.true;
    expect(lex.isStem("trolling")).not.to.be.true;
    expect(lex.isStem("change")).to.not.be.true;
  });
