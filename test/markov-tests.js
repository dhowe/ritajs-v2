describe('RiTa.Markov', () => {
  ...
  it('Should correct call Random.ndist.temp', () => {
    let weights, expected, results;
  ...
  it('Should corrextly call generate.minMaxLength', () => {
  ...
  it('Should fail for sentence in inputs', () => {
    let rm = new Markov(4);
    rm.addText(['I ate the dog.']);
    expect(() => rm.generate()).to.throw;
  });

  it('Should handle disableInputChecks', () => {
