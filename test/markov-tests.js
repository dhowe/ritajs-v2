describe('RiTa.Markov', () => {
  ...
  it('should correctly call toString', () => {
    ...
    rm = new Markov(2);
    exp = "ROOT {   '<s>' [1,p=0.333]  {     'The' [1,p=1.000]   }   'The' [1,p=0.333]  {     '</s>' [1,p=1.000]   }   '</s>' [1,p=0.333] }";
    rm.addText('The');
    ...
    rm = new Markov(2);
    exp = "ROOT {   '<s>' [1,p=0.143]  {     'The' [1,p=1.000]   }   'The' [1,p=0.143]  {     'dog' [1,p=1.000]   }   'dog' [1,p=0.143]  {     'ate' [1,p=1.000]   }   'ate' [1,p=0.143]  {     'the' [1,p=1.000]   }   'the' [1,p=0.143]  {     'cat' [1,p=1.000]   }   'cat' [1,p=0.143]  {     '</s>' [1,p=1.000]   }   '</s>' [1,p=0.143] }";
