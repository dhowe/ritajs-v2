...
export default class RiScriptParser extends antlr4.Parser {
    ...
    static symbolicNames = [ null, "LCOMM", "BCOMM", "Q", "MDS", "GT", "LT", 
                             ...
                             "CONT", "BS", "NL", "DIDENT", "DYN", "SYM", 
                             "OR", "EQ", "ENT", "INT", "OP", "CHR", "IDENT", 
                             "MDT", "MDE" ];
    static ruleNames = [ "script", "line", "expr", "cexpr", "cond", "weight", 
                         "assign", "chars", "transform", "dynamic", "symbol", 
                         "choice", "wexpr", "link", "url", "op" ];
	...
	line() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(((((_la - 5)) & ~0x1f) == 0 && ((1 << (_la - 5)) & ((1 << (RiScriptParser.GT - 5)) | (1 << (RiScriptParser.LT - 5)) | (1 << (RiScriptParser.LP - 5)) | (1 << (RiScriptParser.LB - 5)) | (1 << (RiScriptParser.LCB - 5)) | (1 << (RiScriptParser.DOT - 5)) | (1 << (RiScriptParser.WS - 5)) | (1 << (RiScriptParser.FS - 5)) | (1 << (RiScriptParser.EXC - 5)) | (1 << (RiScriptParser.AST - 5)) | (1 << (RiScriptParser.HAT - 5)) | (1 << (RiScriptParser.DOL - 5)) | (1 << (RiScriptParser.COM - 5)) | (1 << (RiScriptParser.DIDENT - 5)) | (1 << (RiScriptParser.DYN - 5)) | (1 << (RiScriptParser.SYM - 5)) | (1 << (RiScriptParser.ENT - 5)) | (1 << (RiScriptParser.INT - 5)) | (1 << (RiScriptParser.CHR - 5)))) !== 0)) {
	            this.state = 45;
	            this._errHandler.sync(this);
	...
	transform() {
	    ...
	    try {
	        ...
	        if(la_===1) {
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if(((((_la - 5)) & ~0x1f) == 0 && ((1 << (_la - 5)) & ((1 << (RiScriptParser.GT - 5)) | (1 << (RiScriptParser.LT - 5)) | (1 << (RiScriptParser.LP - 5)) | (1 << (RiScriptParser.DOT - 5)) | (1 << (RiScriptParser.WS - 5)) | (1 << (RiScriptParser.FS - 5)) | (1 << (RiScriptParser.EXC - 5)) | (1 << (RiScriptParser.AST - 5)) | (1 << (RiScriptParser.HAT - 5)) | (1 << (RiScriptParser.DOL - 5)) | (1 << (RiScriptParser.COM - 5)) | (1 << (RiScriptParser.DIDENT - 5)) | (1 << (RiScriptParser.DYN - 5)) | (1 << (RiScriptParser.SYM - 5)) | (1 << (RiScriptParser.ENT - 5)) | (1 << (RiScriptParser.INT - 5)) | (1 << (RiScriptParser.CHR - 5)))) !== 0)) {
	                this.state = 136;
	                this.expr();
	            }
	...
	choice() {
	    ...
	    this.enterRule(localctx, 22, RiScriptParser.RULE_choice);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 163;
	        this.match(RiScriptParser.LP);
	...
	wexpr() {
	    ...
	    this.enterRule(localctx, 24, RiScriptParser.RULE_wexpr);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 182;
	...
	link() {
	    ...
	    this.enterRule(localctx, 26, RiScriptParser.RULE_link);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 187;
	        this.match(RiScriptParser.LB);
	...
	url() {
	    ...
	    this.enterRule(localctx, 28, RiScriptParser.RULE_url);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 200; 
...
RiScriptParser.DIDENT = 24;
RiScriptParser.DYN = 25;
RiScriptParser.SYM = 26;
RiScriptParser.OR = 27;
RiScriptParser.EQ = 28;
RiScriptParser.ENT = 29;
RiScriptParser.INT = 30;
RiScriptParser.OP = 31;
RiScriptParser.CHR = 32;
RiScriptParser.IDENT = 33;
RiScriptParser.MDT = 34;
RiScriptParser.MDE = 35;
...
RiScriptParser.RULE_choice = 11;
RiScriptParser.RULE_wexpr = 12;
RiScriptParser.RULE_link = 13;
RiScriptParser.RULE_url = 14;
