...
var ruleNames =  [ "script", "transform", "ident", "symbol", "wexpr", "choice", 
                   "inline", "assign", "weight", "num", "expr" ];
...
RiScriptParser.RULE_wexpr = 4;
RiScriptParser.RULE_choice = 5;
RiScriptParser.RULE_inline = 6;
RiScriptParser.RULE_assign = 7;
RiScriptParser.RULE_weight = 8;
RiScriptParser.RULE_num = 9;
RiScriptParser.RULE_expr = 10;
...
RiScriptParser.prototype.wexpr = function() {
    ...
    this.enterRule(localctx, 8, RiScriptParser.RULE_wexpr);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 42;
...
RiScriptParser.prototype.weight = function() {
    ...
    this.enterRule(localctx, 16, RiScriptParser.RULE_weight);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 76;
...
RiScriptParser.prototype.num = function() {
    ...
    this.enterRule(localctx, 18, RiScriptParser.RULE_num);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 84;
...
ExprContext.prototype.INT = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
...
RiScriptParser.prototype.expr = function() {
    ...
    this.enterRule(localctx, 20, RiScriptParser.RULE_expr);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 95; 
